# Mixnonverbal tasks for returning subjects
#-------------------imports--------------------------------------------------------------------
...
def MixNonverbal_r(var,doo,myPoints,dbc,mouse,getName=True,sub_id=None):
    ...
    setupList = fc.nonverbalSetup(var.nonverbalTotalTrial_r,var.mag,var.shortmag) # setup the reward of blocks for the whole experiment(same as in nonverbal)
...
if __name__ == "__main__":
    MixNonverbal_r(var,doo,myPoints,dbc,mouse) # run main function
