...
#---------------Main Function-------------------------------------
def verbal_even(var,doo,mouse,myPoints,dbc):
    ...
    p_net,pick1,pay_delay1,pay_num1,trials_long1,points_long1 = Long_Verbal.LongVerbal(var,doo,myPoints,dbc,mouse) # run the first long verbal session and record the returned info
    ...
    p_net,points_short1,trials_short1,trialsCorrect_short1 = Short_Verbal.ShortVerbal(var,doo,myPoints,dbc,mouse,getName=False,sub_id=p_net) # run short verbal session #1
    fc.block_break(var,doo)  # show the break instruction to subject
    ...
    fc.block_break(var,doo) # show the break instruction to subject
    Short_Verbal.ShortVerbal(var,doo,myPoints,dbc,mouse,getName=False,sub_id=p_net,pre_points=points_short1,pre_trials=trials_short1,pre_trialsCorrect=trialsCorrect_short1) # run short verbal session #2
...
if __name__ == "__main__":
    verbal_even(var,doo,mouse,myPoints,dbc) # call main function