...
def learn_r(var,doo,myPoints,dbc,mouse): # main function of the learning stages for returning subjects
   ...
   #------------participant info collecting------------------------
    ...
    var = stage4_r.stage4_r(var.sessid,var,doo,myPoints,dbc,mouse) # a shorter version compared to new subjects
    Points4,trials4 = fc.total_Points_trialCounter(var)
    fc.reset_Points_trialCounter(var)


    var = stage5_r.stage5_r(var.sessid,var,doo,myPoints,dbc,mouse) # a shorter version compared to new subjects
...
if __name__ == '__main__':
    learn_r(var,doo,myPoints,dbc,mouse) # call main function of learning stages for returning subjects