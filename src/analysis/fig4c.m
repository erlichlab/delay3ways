...
axes(ax);
cl = parula(6);
[f1,x1] = ksdensity(NC_logk_NV); plot(x1,f1,'Color',cl(1,:),'LineWidth',2); hold on;
[f2,x2] = ksdensity(NC_logk_SV); plot(x2,f2,'--','Color',cl(2,:),'LineWidth',2);    %title('SV vs. NV');
hold on; [f3,x3] = ksdensity(NC_logk_LV); plot(x3,f3,'-.','Color',cl(4,:),'LineWidth',2);
...
%saveas(gcf, '~/repos/delay3ways/data/NC_F4ac_cout.pdf')